        ...
        return (
            <div>
                <div className="form-group">
                    <label for="street_id" className="control-label">Street Address</label>
                    <input type="text" className="form-control" id="street_id" name="street" placeholder="Street address"/>
                </div>					
